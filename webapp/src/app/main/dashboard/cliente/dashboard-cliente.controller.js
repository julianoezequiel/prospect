(function ()
{
    ...
    angular
        ...
        .controller('DashboardClienteController', DashboardClienteController);

    /** @ngInject */
    function DashboardClienteController($scope, $interval, $mdSidenav, DashboardData)
    {
        var vm = this;
        ...
        vm.orcamentosPendentes = {
            title       : vm.dashboardData.orcamentosPendentes.title,
            ranges      : vm.dashboardData.orcamentosPendentes.ranges,
            schedule    : vm.dashboardData.orcamentosPendentes.schedule,
            currentRange: 'T'
        };
